        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/providers`} className="text-gray-400 hover:text-white">
                  {t('findProviders')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/provider/register`} className="text-gray-400 hover:text-white">
                  {t('becomeProvider')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/breeds`} className="text-gray-400 hover:text-white">
                  {t('dogBreeds')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/faq`} className="text-gray-400 hover:text-white">
                  {t('faq')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:legal@tour.pet" className="text-gray-400 hover:text-white">
                  {t('contact')}
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} TourPet. {t('copyright')}
            </p>
