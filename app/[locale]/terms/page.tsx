        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">{t('section1.p2')}</p>
            </section>

            {/* 2. Service Description */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('section2.title')}</h2>
              <p className="text-gray-700 mb-4">{t('section2.p1')}</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4 font-semibold uppercase">{t('section4.p1')}</p>
              <p className="text-gray-700 mb-4">{t('section4.p2')}</p>
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('section5.providers.title')}</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('section5.customers.title')}</h3>
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4 font-semibold uppercase">{t('section6.p1')}</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">{t('section7.p1')}</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">{t('section10.p1')}</p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">{t('section12.p1')}</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">{t('section13.p1')}</p>
            </section>

            {/* 14. Governing Law */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('section14.title')}</h2>
              <p className="text-gray-700">{t('section14.p1')}</p>
            </section>

            {/* 15. Contact Information */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t('section15.title')}</h2>
              <p className="text-gray-700 mb-2">{t('section15.p1')}</p>
