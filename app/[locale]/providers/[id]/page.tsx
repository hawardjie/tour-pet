          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('provider.about')}</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{provider.bio}</p>
              </div>

              {/* Services */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('provider.servicesAndPricing')}</h2>
                ...
                <div className="space-y-6">
                  <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="ml-2 font-medium text-gray-900 dark:text-white">{t('provider.sampleReviewer1')}</span>
                      <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">2 {t('provider.weeksAgo')}</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300">{t('provider.sampleReview1')}</p>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                    <div className="flex items-center mb-2">
                      <div className="flex text-yellow-500">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <svg key={star} className={`w-4 h-4 ${star <= 4 ? 'fill-current' : 'fill-gray-300 dark:fill-gray-600'}`} viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                          </svg>
                        ))}
                      </div>
                      <span className="ml-2 font-medium text-gray-900 dark:text-white">{t('provider.sampleReviewer2')}</span>
                      <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">1 {t('provider.monthAgo')}</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300">{t('provider.sampleReview2')}</p>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="ml-2 font-medium text-gray-900 dark:text-white">{t('provider.sampleReviewer3')}</span>
                      <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">3 {t('provider.weeksAgo')}</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300">{t('provider.sampleReview3')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {/* Contact Info */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('provider.contactInfo')}</h3>
              ...
              {/* Service Area */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('provider.serviceArea')}</h3>
                <div className="space-y-3">
                  <div className="flex items-center text-gray-700 dark:text-gray-300">
                    <svg className="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="text-sm">
                      ...
                      <div className="text-gray-500 dark:text-gray-400">{provider.location}, {provider.city}</div>
                    </div>
                  </div>
              ...
              {/* Availability */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('provider.availability')}</h3>
                <div className="space-y-2">
                  {Object.entries(provider.availability).map(([day, available]) => (
                    <div key={day} className="flex justify-between items-center">
                      <span className="text-sm text-gray-700 dark:text-gray-300 capitalize">{t(`provider.${day}`)}</span>
