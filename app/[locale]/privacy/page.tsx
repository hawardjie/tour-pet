    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 shadow-lg rounded-lg p-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-8">{t('lastUpdated')}: October 24, 2025</p>

          <div className="prose prose-blue max-w-none">
            {/* Introduction */}
            <section className="mb-8">
              <p className="text-gray-700 dark:text-gray-200 mb-4">{t('intro.p1')}</p>
              <p className="text-gray-700 dark:text-gray-200">{t('intro.p2')}</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section1.sub1.title')}</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 mb-4 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section1.sub2.title')}</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 mb-4 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section1.sub3.title')}</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-2">{t('section1.sub3.p1')}</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-200 mb-4">{t('section3.p1')}</p>

              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section3.sub1.title')}</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 mb-4 space-y-2">
                <li>{t('section3.sub1.item1')}</li>
                <li>{t('section3.sub1.item2')}</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section3.sub2.title')}</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 mb-4 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('section3.sub3.title')}</h3>
              <p className="text-gray-700 dark:text-gray-200">{t('section3.sub3.p1')}</p>
            </section>

            {/* 4. Third-Party Services */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">{t('section4.title')}</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">{t('section4.p1')}</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-200">{t('section7.p2')}</p>
            </section>

            {/* 8. California Privacy Rights */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">{t('section8.title')}</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">{t('section8.p1')}</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 space-y-2">
